...
def process_invoices(pdf_dir):
    """Procesa todos los archivos PDF en el directorio especificado y guarda los resultados en Google Sheets."""
    for file_name in os.listdir(pdf_dir):
        if file_name.lower().endswith(".pdf"):  # Solo procesa archivos PDF
